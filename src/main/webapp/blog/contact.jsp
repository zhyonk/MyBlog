...
<!-- Custom Fonts -->
<link rel="stylesheet"
	href="../blog/font-awesome-4.4.0/css/font-awesome.min.css"
	type="text/css">
...
<body class="sub-page">
							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<form id="form1" method="post"
										action="<%=basePath1%>sendFeedbackEmail">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<input type="text" class="form-control input-lg"
														name="name" id="name" placeholder="名字" required="required" />
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control input-lg"
														name="type" id="type" placeholder="类型" required="required" />
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<textarea name="suggestion" id="suggestion" class="form-control"
														rows="4" cols="25" required="required" placeholder="意见"
														style="height: 190px;"></textarea>
												</div>
												<button type="button" class="btn btn-skin btn-block"
													name="submitcontact" id="submitcontact" onclick="sendMail()">提交</button>
											</div>
										</div>
									</form>
								</div>
	...
	<script>
		...
		function sendMail() {
			var mailAccount = $("#email").val();
			data1 = $('#form1').serialize()
